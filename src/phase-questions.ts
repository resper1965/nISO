...
// Metadados por fase (título + cláusula ISO âncora), extraídos da estrutura da
// jornada. Usados pela interpretação (F2) para ancorar o diagnóstico na cláusula
// específica — não num texto genérico.
export const PHASE_META: Record<number, { titulo: string; clausula: string }> = {
  0: { titulo: 'Mobilização e Mandato', clausula: '5.1' },
  1: { titulo: 'Entrevista Executiva', clausula: '5.2 & 6.2' },
  2: { titulo: 'Entrevistas por Trilha', clausula: '7.2' },
  3: { titulo: 'Definição de Escopo', clausula: '4.3' },
  4: { titulo: 'Gap Assessment', clausula: '6.1' },
  5: { titulo: 'Governança e Papéis', clausula: '5.3' },
  6: { titulo: 'Contexto e Partes Interessadas', clausula: '4.1 & 4.2' },
  7: { titulo: 'Inventário de Ativos e Dados', clausula: 'A.5.9' },
  8: { titulo: 'Mapeamento de Processos', clausula: '' },
  9: { titulo: 'Riscos de Segurança', clausula: '6.1.2' },
  10: { titulo: 'Riscos de Privacidade', clausula: '27701' },
  11: { titulo: 'Tratamento de Riscos', clausula: '6.1.3' },
  12: { titulo: 'SoA do SGSI', clausula: '6.1.3d' },
  13: { titulo: 'SoA do SGPI', clausula: '27701' },
  14: { titulo: 'Arquitetura Documental', clausula: '7.5' },
  15: { titulo: 'Controles Organizacionais', clausula: 'A.5' },
  16: { titulo: 'Controles de Pessoas', clausula: 'A.6' },
  17: { titulo: 'Controles Físicos', clausula: 'A.7' },
  18: { titulo: 'Controles Tecnológicos', clausula: 'A.8' },
  19: { titulo: 'Desenvolvimento Seguro', clausula: 'A.8.25' },
  20: { titulo: 'Cloud, DevOps e SRE', clausula: 'A.5.23' },
  21: { titulo: 'Programa de Privacidade', clausula: '27701' },
  22: { titulo: 'Privacy by Design', clausula: '' },
  23: { titulo: 'Direitos dos Titulares', clausula: '' },
  24: { titulo: 'Consentimento e Bases Legais', clausula: '' },
  25: { titulo: 'Retenção e Descarte', clausula: 'A.8.10' },
  26: { titulo: 'Transferências e Compartilhamento', clausula: '' },
  27: { titulo: 'Fornecedores e Operadores', clausula: 'A.5.19' },
  28: { titulo: 'Incidentes', clausula: 'A.5.24-28' },
  29: { titulo: 'Treinamento', clausula: 'A.6.3' },
  30: { titulo: 'Monitoramento e Métricas', clausula: '9.1' },
  31: { titulo: 'Auditoria Interna', clausula: '9.2' },
  32: { titulo: 'Não Conformidades', clausula: '10.1' },
  33: { titulo: 'Análise Crítica pela Direção', clausula: '9.3' },
